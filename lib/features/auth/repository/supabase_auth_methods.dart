...
// import 'package:notesapp/core/provider/supabase_credentials.dart';
...
//   }) async {
//     try {
//       supabase.AuthResponse result = await SupabaseCredentials.supabaseClient.auth.signUp(
//         email: email,
//         password: password,
//       );
...
//     //   );
//       // await _firestore.collection('users').doc(user?.id).set(usertemp.toMap());
